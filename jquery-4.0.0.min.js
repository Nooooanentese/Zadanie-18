...
$("#klik").hover(function(){
$(this).css("background-color", "#caf0f8");
$(this).animate({height:'50px', width:'120px'});
});
...
$("#klik2").hover(function(){
$(this).fadeTo(200, 0.5);
}, function(){
$(this).fadeTo(200, 1); //<- zanikanie
});
 
 
// klik3
$("#klik3").click(function(){
$("p").slideToggle(500); //<- paragraf jezdzi wchodzac i wychodzac
});
...
"transition":"0.5s" //<- animacja przewrotu
});
});
...
$("#klik5").hover(
function(){
$(this).text("nooo no no no"); //<- zmienia tekst
$(this).animate({marginLeft:'+=100px'},300); //<- guzik ucieka po 100 pixeli
},
function(){
$(this).text("klik");
});
